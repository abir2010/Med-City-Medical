...
import footerImg from '../../images/icon/icons8-doctors-bag-50.png';
import "./Footer.css";

const Footer = () => {
  return (
    <div>
      <footer className="px-4 divide-y bg-green-300 dark:bg-coolGray-800 dark:text-coolGray-100">
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          ...
          <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            ...
            <div className="space-y-3">
              <div className="uppercase mr-24 dark:text-coolGray-50">
                Social media
              </div>
        ...
        <div className="py-6 text-sm text-center dark:text-coolGray-400">
          © 1968 Med-City Company Co. All rights reserved.
        </div>
      </footer>
    </div>
  );
